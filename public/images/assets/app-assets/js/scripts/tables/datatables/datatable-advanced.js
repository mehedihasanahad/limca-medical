...
$(document).ready(function() {
    ...
    $(' .buttons-csv').addClass('btn btn-primary mr-1');
    
    // #myTable1_filter
    var table = $('#myTable1_length');
    if(table.length > 0) {
        var myTable1_length = $('#myTable1_length');
        var label = $('#myTable1_filter').find('label');
        // Cut the myTable1_length and insert it before the label
        label.before(myTable1_length);
    }
