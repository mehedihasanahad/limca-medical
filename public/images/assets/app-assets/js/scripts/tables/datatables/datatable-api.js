...
if(table.length > 0) {
    ...
    // Cut the tfoot and insert it before the thead
    thead.before(tfoot);
}
...
jQuery('.delete_all').on('click', function(e) {
    ...
    var allVals = [];
        ...
        if(allVals.length <=0)
        {
            ...
            var confirm_delete = "Are you sure you want to delete selected patients?";
            ...
            if(check == true){
                ...
                $.ajax({
                    ...
                    cache:false,
                    dataType: 'JSON',
                    data: {ids:join_selected_values, action:'deletePatient', nonce:nonce},
