...
@section('public-content')
    <div id="mainContent">
        ...
        <h1 style="margin: 0; padding-top: 65px;">Welcome to LIMCA</h1>
        <h3>We wish your good health and happiness</h3>
        <div class="div-style wrapper">
            ...
            <h3 style="color: black; margin-top:10px; font-weight: bold;">Medical Examinations</h3>
            <p>Book your health check-up appointment or view your test results</p>
            <div class="appointment_report">
